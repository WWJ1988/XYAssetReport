(function () {
    ...
    try {
        multiSelectModule = angular.module("uiMultiSelect")
    } catch (err) {
        multiSelectModule = null;
    }
    ...
    angular.module("uiMultiSelect").run(["$templateCache", function ($templateCache) {
        $templateCache.put("template/multiselect/multiselectPopup.html",
            ...
            "</div>" +
            "</li>" +
            "<li ng-show=\"multiple && (enableCheckAll)\">" +
            "<div ng-if=\"enableCheckAll\" class=\"checkbox\"><label><input type=\"checkbox\" ng-click=\"checkAll()\">{{checkAllLabel}}</label></div>" +
            "</li>" +
            "<li ng-show=\"maxSelected\">" +
            "<small>Selected maximum of </small><small ng-bind=\"selectLimit\"></small>" +
            "</li>" +
            "<li ng-repeat=\"i in items | filter:searchText\">" +
            "<div class=\"checkbox\"><label><input type=\"checkbox\" ng-model=\"i.checked\" ng-click=\"select(i);\">{{i.label}}</label></div>" +
            "</li>" +
            "</ul>" +
            "</div>");
    }]);
