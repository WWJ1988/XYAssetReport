...
var BrandWidgetComponent = (function () {
    function BrandWidgetComponent(dataService) {
        this.dataService = dataService;
    }
    BrandWidgetComponent.prototype.ngOnInit = function () {
        ...
        var keys = Object.keys(this.brandDetails);
    ...
    BrandWidgetComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
        ...
        __metadata('design:paramtypes', [dataService_1.DaikuanDataService])
    ], BrandWidgetComponent);
    return BrandWidgetComponent;
}());
exports.BrandWidgetComponent = BrandWidgetComponent;
//# sourceMappingURL=brandwidget.component.js.map