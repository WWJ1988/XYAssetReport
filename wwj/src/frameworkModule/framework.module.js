...
var FrameworkModule = (function () {
    ...
    FrameworkModule = __decorate([
        core_1.NgModule({
            declarations: [lbar_component_1.FrameworkLbar, rbar_component_1.FrameworkRbar, lrbar_component_1.FrameworkLRbar],
            exports: [lbar_component_1.FrameworkLbar, rbar_component_1.FrameworkRbar, lrbar_component_1.FrameworkLRbar]
        }), 
